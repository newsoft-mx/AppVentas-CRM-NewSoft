  ...
  return (
    <div>
      ...
      <div className="mt-2 divide-y divide-surface-border rounded-lg border border-surface-border">
        {opciones.length === 0 && <p className="p-4 text-sm text-gray-500">Sin opciones. Agregá la primera.</p>}
        {opciones.map((op) => (
            ...
            {editId === op.id ? (
              ...
              <>
                <span className="flex-1 text-sm text-navy">
                  {op.nombre}
                  {!op.activo && <span className="ml-2 text-xs text-gray-500">(inactivo)</span>}
                </span>
                <button
                ...
                <button
                  ...
                  className="text-gray-500 hover:text-red-500" title="Eliminar"
